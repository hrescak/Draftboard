...
"[project]/src/components/user/UserProfile.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UserProfile(param) {
    ...
    const isOwnProfile = (session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.id) === user.id;
    ...
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$trpc$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post.byUser.useInfiniteQuery({
        userId: user.id,
        limit: 10
    }, {
        getNextPageParam: {
            "UserProfile.useInfiniteQuery": (lastPage)=>lastPage.nextCursor
        }["UserProfile.useInfiniteQuery"]
    });
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: [
                                            "Joined ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRelativeTime"])(new Date(user.createdAt))
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/user/UserProfile.tsx",
                                        lineNumber: 82,
...
_s(UserProfile, "04GvMp84//6gy8N5L4bZkd65dj4=", false, function() {
    return [
...
//# sourceMappingURL=src_components_7aca6a82._.js.map