 ...
 */ function $isRootTextContentEmpty(isEditorComposing) {
    let trim = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
 ...
 */ function getCSSFromStyleObject(styles) {
    ...
    for(const style in styles){
        if (style) {
            css += "".concat(style, ": ").concat(styles[style], ";");
        }
    }
    return css;
}
 ...
 */ function $patchStyle(target, patch) {
    ...
    const newStyles = Object.entries(patch).reduce((styles, param)=>{
        let [key, value] = param;
 ...
 */ function $setBlocksType(selection, $createElement) {
    let $afterCreateElement = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : $copyBlockFormatIndent;
    if (selection === null) {
        return;
    }
 ...
 */ function $wrapNodes(selection, createElement) {
    let wrappingElement = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
    const anchorAndFocus = selection.getStartEndPoints();
 ...
 */ function $wrapNodesImpl(selection, nodes, nodesLength, createElement) {
    let wrappingElement = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null;
    if (nodes.length === 0) {
        return;
    }
 ...
 */ function $getSelectionStyleValueForProperty(selection, styleProperty) {
    let defaultValue = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : '';
    let styleValue = null;
    const nodes = selection.getNodes();
 ...
 */ function markSelection(editor, onReposition) {
    ...
    return mergeRegister(editor.registerUpdateListener((param)=>{
 ...
 */ function $getNearestBlockElementAncestorOrThrow(startNode) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$isElementNode"])(blockNode)) {
        {
            formatDevErrorMessage("Expected node ".concat(startNode.__key, " to have closest block element node."));
        }
    }
    return blockNode;
}
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeStepwiseIterator"])({
        ...
        map: (caret)=>{
            ...
            if (seen !== null) {
                ...
                if (!!seen.has(key)) {
                    formatDevErrorMessage("$childIterator: Cycle detected, node with key ".concat(String(key), " has already been traversed"));
                }
                seen.add(key);
            }
            return origin;
...
function $appendNodesToHTML(editor, currentNode, parentElement) {
    let selection = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
...
function $createNodesFromDOM(node, editor, allArtificialNodes, hasBlockAncestorLexicalNode) {
    let forChildMap = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : new Map(), parentLexicalNode = arguments.length > 5 ? arguments[5] : void 0;
    let lexicalNodes = [];
 ...
 */ function $getHtmlContent(editor) {
    let selection = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$getSelection"])();
    if (selection == null) {
        {
...
function exportNodeToJSON(node) {
    ...
    if (serializedNode.type !== nodeClass.getType()) {
        {
            formatDevErrorMessage("LexicalNode: Node ".concat(nodeClass.name, " does not implement .exportJSON()."));
        }
    }
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$isElementNode"])(node)) {
...
function $appendNodesToJSON(editor, selection, currentNode) {
    let targetArray = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : [];
    let shouldInclude = selection !== null ? currentNode.isSelected(selection) : true;
    const shouldExclude = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$isElementNode"])(currentNode) && currentNode.excludeFromCopy('html');
    let target = currentNode;
    if (selection !== null) {
 ...
 */ function $getClipboardDataFromSelection() {
    let selection = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lexical$2f$Lexical$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$getSelection"])();
    const clipboardData = {
...
function $createHeadingNode() {
    let headingTag = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'h1';
 ...
 */ function registerHistory(editor, historyState, delay) {
    ...
    const applyChange = (param)=>{
        let { editorState, prevEditorState, dirtyLeaves, dirtyElements, tags } = param;
        const current = historyState.current;
        const redoStack = historyState.redoStack;
        const undoStack = historyState.undoStack;
...
function applyMarkerStyles(dom, node, prevNode) {
    ...
    for(const k in styles){
        dom.style.setProperty("--listitem-marker-".concat(k), styles[k]);
    }
    if (prevNode) {
        for(const k in (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lexical$2f$selection$2f$LexicalSelection$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStyleObjectFromCSS"])(prevNode.__textStyle)){
            if (!(k in styles)) {
                dom.style.removeProperty("--listitem-marker-".concat(k));
            }
        }
    }
}
...
function $setListThemeClassNames(dom, editorThemeClasses, node) {
    ...
    if (listTheme !== undefined) {
        const listLevelsClassNames = listTheme["".concat(node.__tag, "Depth")] || [];
 ...
 */ function $createListNode() {
    let listType = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'number', start = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
...
function $createCodeHighlightNode() {
    let text = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '', highlightType = arguments.length > 1 ? arguments[1] : void 0;
 ...
 */ function $createLinkNode() {
    let url = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '', attributes = arguments.length > 1 ? arguments[1] : void 0;
 ...
 */ function createMarkdownExport(transformers) {
    let shouldPreserveNewLines = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
function createTextFormatTransformersIndex(textTransformers) {
    ...
    for (const transformer of textTransformers){
        ...
        // Single-char tag (e.g. "*"),
        if (tag.length === 1) {
            fullMatchRegExpByTag[tag] = new RegExp("(?<![\\\\".concat(tagRegExp, "])(").concat(tagRegExp, ")((\\\\").concat(tagRegExp, ")?.*?[^").concat(tagRegExp, "\\s](\\\\").concat(tagRegExp, ")?)((?<!\\\\)|(?<=\\\\\\\\))(").concat(tagRegExp, ")(?![\\\\").concat(tagRegExp, "])"));
        } else {
            // Multi‐char tags (e.g. "**")
            fullMatchRegExpByTag[tag] = new RegExp("(?<!\\\\)(".concat(tagRegExp, ")((\\\\").concat(tagRegExp, ")?.*?[^\\s](\\\\").concat(tagRegExp, ")?)((?<!\\\\)|(?<=\\\\\\\\))(").concat(tagRegExp, ")(?!\\\\)"));
        }
    }
    return {
        ...
        openTagsRegExp: new RegExp("".concat(escapeRegExp, "(").concat(openTagsRegExp.join('|'), ")"), 'g'),
        transformersByTag
    };
}
/**
...
function registerMarkdownShortcuts(editor) {
    let transformers = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : TRANSFORMERS;
    const byType = transformersByType(transformers);
    const textFormatTransformersByTrigger = indexBy(byType.textFormat, (param)=>{
        let { tag } = param;
        return tag[tag.length - 1];
    });
    const textMatchTransformersByTrigger = indexBy(byType.textMatch, (param)=>{
        let { trigger } = param;
        return trigger;
    });
    for (const transformer of transformers){
        ...
        if (type === 'element' || type === 'text-match' || type === 'multiline-element') {
            ...
            for (const node of dependencies){
                if (!editor.hasNode(node)) {
                    {
                        formatDevErrorMessage("MarkdownShortcuts: missing dependency ".concat(node.getType(), " for transformer. Ensure node dependency is included in editor initial config."));
                    }
                }
            }
        }
    ...
    return editor.registerUpdateListener((param)=>{
        let { tags, dirtyLeaves, editorState, prevEditorState } = param;
...
const listExport = (listNode, exportChildren, depth)=>{
    ...
    for (const listItemNode of children){
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lexical$2f$list$2f$LexicalList$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$isListItemNode"])(listItemNode)) {
            ...
            const prefix = listType === 'number' ? "".concat(listNode.getStart() + index, ". ") : listType === 'check' ? "- [".concat(listItemNode.getChecked() ? 'x' : ' ', "] ") : '- ';
...
const LINK = {
    ...
    export: (node, exportChildren, exportFormat)=>{
        ...
        const linkContent = title ? "[".concat(textContent, "](").concat(node.getURL(), ' "').concat(title, '")') : "[".concat(textContent, "](").concat(node.getURL(), ")");
        return linkContent;
    },
    importRegExp: /(?:\[([^[]+)\])(?:\((?:([^()\s]+)(?:\s"((?:[^"]*\\")*[^"]*)"\s*)?)\))/,
    regExp: /(?:\[([^[]+)\])(?:\((?:([^()\s]+)(?:\s"((?:[^"]*\\")*[^"]*)"\s*)?)\))$/,
    replace: (textNode, match)=>{
        ...
        const linkNode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$lexical$2f$link$2f$LexicalLink$2e$dev$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["$createLinkNode"])(formattedUrl, {
            title: linkTitle
        });
...
function normalizeMarkdown(input) {
    let shouldMergeAdjacentLines = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
 ...
 */ function $convertFromMarkdownString(markdown) {
    let transformers = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : TRANSFORMERS, node = arguments.length > 2 ? arguments[2] : void 0, shouldPreserveNewLines = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, shouldMergeAdjacentLines = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
 ...
 */ function $convertToMarkdownString() {
    let transformers = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : TRANSFORMERS, node = arguments.length > 1 ? arguments[1] : void 0, shouldPreserveNewLines = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
...
//# sourceMappingURL=node_modules_d0d79921._.js.map